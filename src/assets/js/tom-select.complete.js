...
const f = new RegExp(Object.keys(g).join("|") + "|[̀-ͯ·ʾʼ]", "gu"),
    m = (e, t = "NFKD") => e.normalize(t),
    y = e => c(e).reduce(((e, t) => e + O(t)), ""),
    O = e => (e = m(e).toLowerCase().replace(f, (e => g[e] || "")), m(e, "NFC"));
const b = e => {
        const t = {},
            i = (e, i) => {
                const s = t[e] || new Set,
        ...
        for (let s of function*(e) {
            ...
            }(e)) i(s.folded, s.folded), i(s.folded, s.composed);
        return t
    },
    w = e => {
        const t = b(e),
        ...
        for (let i in t) {
            let e = t[i];
            e && (s[i] = n(e)), i.length > 1 && o.push(r(i))
        }
...
const A = e => {
        void 0 === p && (p = w(u)), e = y(e);
        let t = "",
            i = [new I];
        for (let s = 0; s < e.length; s++) {
            let n = e.substring(s).match(h);
...
class P {
    ...
    _getSortFunction(e) {
        ...
        if (o)
            for (let l of o)(e.query || "$score" !== l.field) && i.push(l);
        if (e.query) {
            t = !0;
            for (let e of i)
                if ("$score" === e.field) {
...
const N = (e, t) => {
    ...
    j = e => "string" == typeof e && e.indexOf("<") > -1,
    V = (e, t) => {
...
function ae(e, t) {
    ...
    return "select" === d ? (() => {
        ...
        p.maxItems = e.hasAttribute("multiple") ? null : 1, N(e.children, (e => {
            var i, s, n;
            "optgroup" === (t = e.tagName.toLowerCase()) ? ((n = v(i = e))[a] = n[a] || i.getAttribute("label") || "", n[c] = n[c] || h++, n[r] = n[r] || i.disabled, n.$order = n.$order || ++g, p.optgroups.push(n), s = n[c], N(i.children, (e => {
                f(e, s)
            }))) : "option" === t && f(e)
        }))
    })() : (() => {
...
class de extends(function(e) {
    ...
    constructor(e, t) {
        ...
        const r = $("<div>"),
            ...
            c = $('<div role="listbox" tabindex="-1">'),
            d = this.input.getAttribute("class") || "",
            u = n.mode;
        var p;
        if (D(r, n.wrapperClass, d, u), D(l, n.controlClass), le(r, l), D(a, n.dropdownClass, u), n.copyClassesToDropdown && D(a, d), D(c, n.dropdownContentClass), le(a, c), $(n.dropdownParent || r).appendChild(a), j(n.controlInput)) {
            p = $(n.controlInput);
    ...
    onInput(e) {
        ...
        var i, s;
        this.lastValue !== t && (this.lastValue = t, "" != t ? (this.refreshTimeout && clearTimeout(this.refreshTimeout), this.refreshTimeout = (i = () => {
            this.refreshTimeout = null, this._onInput()
        }, (s = this.settings.refreshThrottle) > 0 ? setTimeout(i, s) : (i.call(null), null))) : this._onInput())
    }
    _onInput() {
    ...
    refreshOptions(e = !0) {
        ...
        })), f.query.length && f.tokens.length && E(f.tokens, (e => {
            U(O, e.regex)
        })));
        var _ = e => {
            let t = h.render(e, {
        ...
        if (h.loading ? _("loading") : h.settings.shouldLoad.call(h, g) ? 0 === f.items.length && _("no_results") : _("not_loading"), (a = h.canCreate(g)) && (d = _("option_create")), h.hasOptions = f.items.length > 0 || a, y) {
            if (f.items.length > 0) {
    ...
    getAdjacent(e, t, i = "option") {
        ...
        for (let n = 0; n < s.length; n++)
            if (s[n] == e) return t > 0 ? s[n + 1] : s[n - 1];
        return null
    }
    getItem(e) {
    ...
    updateOriginalInput(e = {}) {
        ...
        if (t.is_select_tag) {
            let e = function(e, i, s) {
                return e || (e = $('<option value="' + Z(i) + '">' + Z(s) + "</option>")), e != n && t.input.append(e), o.push(e), (e != n || r > 0) && (e.selected = !0), e
            };
            const o = [],
                r = t.input.querySelectorAll("option:checked").length;
            t.input.querySelectorAll("option:checked").forEach((e => {
                e.selected = !1
            })), 0 == t.items.length && "single" == t.settings.mode ? e(n, "", "") : t.items.forEach((n => {
                if (i = t.options[n], s = i[t.settings.labelField] || "", o.includes(i.$option)) {
                    const i = t.input.querySelector(`option[value="${re(n)}"]:not(:checked)`);
                    e(i, n, s)
                } else i.$option = e(i.$option, n, s)
            }))
    ...
    render(e, t) {
        ...
        if (s = $(s), "option" === e || "option_create" === e ? t[n.settings.disabledField] ? Q(s, {
                "aria-disabled": "true"
            }) : Q(s, {
                "data-selectable": ""
...
de.define("change_listener", (function() {
    ...
    e.settings.shouldOpen = !0, e.hook("before", "setup", (() => {
        ...
        const t = $('<div class="dropdown-input-wrap">');
