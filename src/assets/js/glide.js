...
var _ = function() {
    ...
    k = function() {
        function t(e) {
            ...
            i(this, t), this._c = {}, this._t = [], this._e = new _, this.disabled = !1, this.selector = e, this.settings = w(f, n), this.index = this.settings.startAt
        }
        return r(t, [{
            key: "mount",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                return this._e.emit("mount.before"), v(t) ? this._c = function(t, e, n) {
                    var i = {};
                    for (var r in e) m(e[r]) ? i[r] = e[r](t, i, n) : d("Extension must be a function");
                    for (var o in i) m(i[o].mount) && i[o].mount();
                    return i
                }(this, t, this._e) : d("You need to provide a object on `mount()`"), this._e.emit("mount.after"), this
            }
        }, {
            key: "mutate",
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
                return b(t) ? this._t = t : d("You need to provide a array on `mutate()`"), this
            }
        }, {
            key: "update",
            value: function() {
            ...
            set: function(t) {
                v(t) ? this._o = t : d("Options must be an `object` instance.")
            }
        }, {
            key: "index",
            get: function() {
...
function O(t, e) {
    var n, i, r, o, s = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
        a = 0,
        u = function() {
            a = !1 === s.leading ? 0 : S(), n = null, o = t.apply(i, r), n || (i = r = null)
        },
        c = function() {
            var c = S();
            a || !1 !== s.leading || (a = c);
            var l = e - (c - a);
            return i = this, r = arguments, l <= 0 || l > e ? (n && (clearTimeout(n), n = null), a = c, o = t.apply(i, r), n || (i = r = null)) : n || !1 === s.trailing || (n = setTimeout(u, l)), o
        };
    return c.cancel = function() {
        clearTimeout(n), a = 0, n = i = r = null
    }, c
}
var H = {
...
var M = C,
    ...
    I = ["mousedown", "mousemove", "mouseup", "mouseleave"];
...
var X = {
        Html: function(t, e, n) {
            var i = {
                ...
                collectSlides: function() {
                    this.slides = x(this.wrapper.children).filter((function(e) {
            ...
            return y(i, "root", {
                ...
                set: function(t) {
                    p(t) && (t = document.querySelector(t)), null !== t ? i._r = t : d("Root element must be a existing Html node")
                }
            }), y(i, "track", {
                get: function() {
                    return i._t
            ...
            var i = {
                set: function(n) {
                    var i = function(t, e, n) {
                            var i = [V, E, L, z].concat(t._t, [R]);
                            return {
                                mutate: function(r) {
                                    for (var o = 0; o < i.length; o++) {
                                        var s = i[o];
                                        m(s) && m(s().modify) ? r = s(t, e, n).modify(r) : d("Transformer should be a function that returns an object with `modify()` method")
                                    }
                                    return r
                                }
                            }
        ...
        Direction: function(t, e, n) {
            ...
            return y(i, "value", {
                ...
                set: function(t) {
                    j.indexOf(t) > -1 ? i._v = t : d("Direction value must be `ltr` or `rtl`")
                }
        ...
        Peek: function(t, e, n) {
            ...
            return y(i, "value", {
                ...
                set: function(t) {
                    v(t) ? (t.before = h(t.before), t.after = h(t.after)) : t = h(t), i._v = t
                }
            }), y(i, "reductor", {
                get: function() {
                    var e = i.value,
        ...
        Gaps: function(t, e, n) {
            var i = {
                apply: function(t) {
                    for (var n = 0, i = t.length; n < i; n++) {
                        var r = t[n].style,
                            o = e.Direction.value;
                        r[H[o][0]] = 0 !== n ? "".concat(this.value / 2, "px") : "", n !== t.length - 1 ? r[H[o][1]] = "".concat(this.value / 2, "px") : r[H[o][1]] = ""
                    }
                },
                remove: function(t) {
            ...
            }), n.on(["build.after", "update"], O((function() {
            ...
            var i = {
                ...
                collect: function() {
                    var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
                        ...
                        a = r.cloningRatio;
                    if (i.length > 0)
                        for (var u = o + +!!t.settings.peek + Math.round(o / 2), c = i.slice(0, u).reverse(), l = i.slice(-1 * u), f = 0; f < Math.max(a, Math.floor(o / i.length)); f++) {
                            ...
                            for (var p = 0; p < l.length; p++) {
                                ...
                                v.classList.add(s.slide.clone), n.unshift(v)
                            }
                        }
                    return n
                },
                ...
                calculate: function() {
                    ...
                    if (">" !== o || ">" !== r)
                        if ("<" !== o || "<" !== r) {
                            ...
                            d("Invalid direction pattern [".concat(o).concat(r, "] has been used"))
                        } else t.index = 0;
                    else t.index = n
                },
                isStart: function() {
                ...
                c = {
                    ...
                    move: function(i) {
                        if (!t.disabled) {
                            var a = t.settings,
                                ...
                                g = Math.sqrt(v + m),
                                b = Math.sqrt(m);
                            if (!(180 * (r = Math.asin(b / g)) / Math.PI < u)) return !1;
                    ...
                    bindSwipeStart: function() {
                        var n = this,
                            ...
                            o = r.swipeThreshold,
                            s = r.dragThreshold;
                        o && i.on(B[0], e.Html.wrapper, (function(t) {
                            n.start(t)
                        }), u), s && i.on(B[1], e.Html.wrapper, (function(t) {
                            n.start(t)
                        }), u)
                    },
                    ...
                    bindSwipeMove: function() {
                        var n = this;
                        i.on(W, e.Html.wrapper, O((function(t) {
                            n.move(t)
                    ...
                    touches: function(t) {
                        return I.indexOf(t.type) > -1 ? t : t.touches[0] || t.changedTouches[0]
                    },
                    threshold: function(e) {
                        var n = t.settings;
                        return I.indexOf(e.type) > -1 ? n.dragThreshold : n.swipeThreshold
                    },
                    enable: function() {
                ...
                o = {
                    mount: function() {
                        this._n = e.Html.root.querySelectorAll('[data-glide-el="controls[nav]"]'), this._c = e.Html.root.querySelectorAll(F), this._arrowControls = {
                            ...
                            next: e.Html.root.querySelectorAll(N)
                        }, this.addBindings()
                    },
                    setActive: function() {
                    ...
                    addClass: function(e) {
                        var n = t.settings,
                            i = e[t.index];
                        i && (i.classList.add(n.classes.nav.active), T(i).forEach((function(t) {
        ...
        Breakpoints: function(t, e, n) {
            ...
            return Object.assign(r, a.match(o)), i.on("resize", window, O((function() {
                t.settings = w(r, a.match(o))
            }), t.settings.throttle)), n.on("update", (function() {
                o = Y(o), s = Object.assign({}, r)
            })), n.on("destroy", (function() {
                i.off("resize", window)
            })), a
        }
    ...
    K = function() {
        ...
        return r(e, [{
            ...
            value: function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                return l(s(e.prototype), "mount", this).call(this, Object.assign({}, X, t))
            }
        }]), e
    }();
document.addEventListener("DOMContentLoaded", (function() {
    ...
    t.mount(), window.addEventListener("resize", (() => {
        t.update()
    }))
}));
